		...
		struct ccn_upcall_info *ui)
{
	...
	py_o = _ndn_Int_FromLong(ui->matched_comps);
...
PyObject *
_ndn_cmd_is_run_executing(PyObject *UNUSED(self), PyObject *py_handle)
{
	struct ccn *handle;
	PyObject *res;
	...
	res = _ndn_run_state_find(handle) ? Py_True : Py_False;
...
PyObject *
_ndn_cmd_create(PyObject *UNUSED(self), PyObject *UNUSED(args))
{
...
//
// arguments:  CObject that is an opaque reference to the ccn handle, generated by _ndn_ccn_create
// returns:    integer, non-negative if ok (file descriptor)
//

PyObject *
_ndn_cmd_connect(PyObject *UNUSED(self), PyObject *py_ccn_handle)
{
	struct ccn *handle;
	int r;

	if (!CCNObject_IsValid(HANDLE, py_ccn_handle)) {
		PyErr_SetString(PyExc_TypeError, "Must pass a ndn.Face Handle");
		return NULL;
	}
...
PyObject *
_ndn_cmd_disconnect(PyObject *UNUSED(self), PyObject *py_ccn_handle)
{
	struct ccn *handle;
	int r;
...
PyObject *
_ndn_cmd_defer_verification (PyObject *UNUSED(self), PyObject *args)
{
	struct ccn *handle;
        int deferral = 1;
        PyObject *py_handle;
...
PyObject *
_ndn_get_connection_fd(PyObject *UNUSED(self), PyObject *py_handle)
{
	struct ccn *handle;
...
PyObject *
_ndn_cmd_process_scheduled_operations(PyObject *UNUSED(self), PyObject *py_handle)
{
	struct ccn *handle;
...
PyObject *
_ndn_cmd_output_is_pending(PyObject *UNUSED(self), PyObject *py_handle)
{
	struct ccn *handle;
	PyObject *res;
...
PyObject *
_ndn_cmd_run(PyObject *UNUSED(self), PyObject *args)
{
	int r;
	PyObject *py_handle;
	int timeoutms = -1;
	...
	state_slot = _ndn_run_state_add(handle);
	if (!state_slot)
		return NULL;
	...
	_ndn_run_state_clear(state_slot);
...
PyObject *
_ndn_cmd_set_run_timeout(PyObject *UNUSED(self), PyObject *args)
{
	int r;
	PyObject *py_handle;
	int timeoutms = 0;
...
PyObject *
_ndn_cmd_express_interest(PyObject *UNUSED(self), PyObject *args)
{
	...
	if (strcmp(py_ccn->ob_type->tp_name, "Face")) {
...
PyObject *
_ndn_cmd_set_interest_filter(PyObject *UNUSED(self), PyObject *args)
{
	...
	if (!CCNObject_IsValid(HANDLE, py_ccn)) {
		PyErr_SetString(PyExc_TypeError, "Must pass a ndn.Face handle as arg 1");
		return NULL;
	}

	if (!CCNObject_IsValid(NAME, py_name)) {
		PyErr_SetString(PyExc_TypeError, "Must pass a ndn.Face Name as arg 1");
		return NULL;
	}

	if (!PyObject_IsInstance(py_closure, g_type_Closure)) {
		PyErr_SetString(PyExc_TypeError, "Must pass a ndn.Face Closure as arg 3");
		return NULL;
	}
...
PyObject *
_ndn_cmd_clear_interest_filter(PyObject *UNUSED(self), PyObject *args)
{
...
PyObject *
_ndn_cmd_get(PyObject *UNUSED(self), PyObject *args)
{
	...
	_ndn_content_object_set_pco(py_data, pco);
	JUMP_IF_NULL_MEM(pco, exit);
	comps = ccn_indexbuf_create();
	_ndn_content_object_set_comps(py_data, comps);
...
PyObject * // int
_ndn_cmd_put(PyObject *UNUSED(self), PyObject *args)
{
...
PyObject *
_ndn_cmd_get_default_key(PyObject *UNUSED(self), PyObject *UNUSED(arg))
{
	...
	py_ccn_key = _ndn_privatekey_dup(key);
